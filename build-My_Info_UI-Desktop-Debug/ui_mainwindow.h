...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setGeometry(QRect(140, 10, 491, 41));
        view = new QPushButton(centralwidget);
        view->setObjectName(QString::fromUtf8("view"));
        view->setGeometry(QRect(230, 120, 311, 71));
        setting = new QPushButton(centralwidget);
        setting->setObjectName(QString::fromUtf8("setting"));
        setting->setGeometry(QRect(230, 230, 311, 81));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label->setText(QApplication::translate("MainWindow", "                                         WELCOM TO MY CHANNEL", nullptr));
